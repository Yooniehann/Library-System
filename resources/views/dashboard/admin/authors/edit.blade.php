...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-2xl font-bold text-white mb-6">Edit Author</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="fullname" id="fullname"
                            ...
                            value="{{ old('fullname', $author->fullname) }}" required>
                        @error('fullname')
                    ...
                    <div class="mb-4 md:col-span-2">
                        ...
                        <textarea name="biography" id="biography" rows="5"
                            class="bg-slate-700 text-white border border-gray-600 rounded w-full py-2 px-3 focus:outline-none focus:ring-2 focus:ring-yellow-400">{{ old('biography', $author->biography) }}</textarea>
                        @error('biography')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
