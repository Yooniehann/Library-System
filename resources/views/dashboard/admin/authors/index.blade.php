                ...
                <tbody class="bg-slate-800 divide-y divide-gray-700">
                    @foreach ($authors as $author)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">{{ $author->fullname }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                {{ $author->nationality ?? 'N/A' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{{ $author->birth_year ?? 'N/A' }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.authors.edit', $author) }}"
                                        class="text-yellow-400 hover:text-yellow-500">Edit</a>
